...
def WRN16_2(num_classes=10):
    return WideResNet(depth=16, width_factor=2, dropout=0, in_channels=3, num_classes=num_classes)

def WRN16_8(num_classes=10):
    return WideResNet(depth=16, width_factor=8, dropout=0, in_channels=3, num_classes=num_classes)

def WRN28_2(num_classes=10):
    return WideResNet(depth=28, width_factor=2, dropout=0, in_channels=3, num_classes=num_classes)

def WRN28_10(num_classes=10):
    return WideResNet(depth=28, width_factor=10, dropout=0, in_channels=3, num_classes=num_classes)