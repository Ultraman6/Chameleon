...
def PyramidNet110_cifar(num_classes=10):
    """PyramidNet with 110 layers"""
    return PyramidNet(110, 270, num_classes, dataset='cifar')

def PyramidNet110_imagenet(num_classes=10):
    """PyramidNet with 110 layers"""
    return PyramidNet(110, 270, num_classes, dataset='imagenet')
